...
First off, thank you for considering contributing to joshka/ratatui-templates.
...
tracker](https://github.com/joshka/ratatui-templates/issues), please check that it has not already
...
```shell
git clone https://github.com/joshka/ratatui-templates
cd ratatui-templates
cargo generate -path .
```
